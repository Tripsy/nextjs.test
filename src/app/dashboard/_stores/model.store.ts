...
import {
	createModelSelectionSlice,
	type ModelSelectionSlice,
} from '@/app/dashboard/_stores/model-selection.slice';
import type { DataSourceType } from '@/config/data-source';
import {
	createModelModalSlice,
	type ModelModalSlice,
} from './model-modal.slice';
import {
	createModelTableSlice,
...
export const createModelStore = <K extends keyof DataSourceType>(
	dataSource: K,
) =>
	create<ModelStore<K>>()(
		devtools(
...
export type ModelStoreType<
	K extends keyof DataSourceType = keyof DataSourceType,
