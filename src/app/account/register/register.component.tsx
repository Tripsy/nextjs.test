...
export default function Register() {
    const [state, action, pending] = useActionState(registerAction, RegisterState);
    const [showPassword, setShowPassword] = useState(false);

    const [formValues, setFormValues] = useFormValues<RegisterFormFieldsType>(state.values);
    ...
    const handleChange = (name: keyof RegisterFormFieldsType, value: string | boolean) => {
